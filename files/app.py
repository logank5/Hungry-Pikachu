...
def how_to_screen(screen):
    ...
    instructions = [
        ...
        "The goal is to eat as many",
        "apricorns as you can. As you ",
        "collect apricorns, Pokéballs",
        "will be thrown at you. Avoid",
        "being caught. The longer you",
...
def run_game(WIN, SCREEN_WIDTH, SCREEN_HEIGHT, clock, FPS):
    VELOCITY = 7
    SPEED = 7
    SCORE = 0
    ...
    while True:
        ...
        scores_rect = scores.get_rect(center=(SCREEN_WIDTH / 2, 30))
...
def main():
    ...
    while True:
        ...
        if game_state == GameState.TITLE:
            ...
            game_state = run_game(WIN, SCREEN_WIDTH, SCREEN_HEIGHT, clock, FPS)
        elif game_state == GameState.QUIT:
            pygame.quit()
            sys.exit()
        elif game_state == GameState.HOWTO:
            game_state = how_to_screen(WIN)
